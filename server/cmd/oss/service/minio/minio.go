...
func (minio *Minio) PreSignedPutObjectUrl(ctx context.Context, req *oss.PreSignedPutObjectUrlReq) (*oss.PreSignedPutObjectUrlResponse, error) {
	...
	preSignedPutObjectUrl := &oss.PreSignedPutObjectUrlResponse{
