...
type UserInfo struct {
	...
	PhoneNumber int64  `thrift:"phone_number,3" json:"phone_number"`
	AvatarUrl   string `thrift:"avatar_url,4" json:"avatar_url"`
}
...
type GetUserRequest struct {
	AccontId int64 `thrift:"accont_id,1" json:"accont_id"`
}
...
type AuthServiceUploadAvatarArgs struct {
	Req *UploadAvatarRequset `thrift:"req,1" json:"req"`
}
...
type AuthServiceUploadAvatarResult struct {
	Success *UploadAvatarResponse `thrift:"success,0,optional" json:"success,omitempty"`
}
...
type AuthServiceGetUserResult struct {
	Success *UserInfo `thrift:"success,0,optional" json:"success,omitempty"`
}
